...
| Full legal name | Tomas Novak |
| Professional stage name | Tomas Novak |
| Age (locked) | **26** |
...
| Roster path | `C:\Users\NCG\Videos\Grok Projects\Studio\actors_roster\male\europe_east\Tomas_Novak` |

## Mood Modifiers (On & Off Screen)
**Modifiers:** quirky, earnest, anxious
**On-screen:** Quirky deflection; earnest when honest.
**Off-screen / video:** Awkward-charming in video interviews; earnest with fans.
...
5'11", lanky build, messy brown hair, hazel eyes, pale skin, angular features, wire-frame glasses off-duty.

## Tattoo Inventory
None — continuity: no tattoo additions without canon update.

## Signature Looks
Hoodies, glasses, muted tones.
...
## Performance Style
Naturalistic fidget; honesty in pause.

## Voice Notes
Soft tenor; rapid Czech-English code-switch.

## On-Screen Comfort
Story-serving intimacy per Protocol v1.3; clinical prompt language; PG-13 baseline; no explicit content.

## Personality
Anxiety as fuel for honesty.

## Base Reference Images / Wardrobe Anchors
- Neutral casting wardrobe anchor — Tomas Novak
- Primary story wardrobe — Tomas Novak

## Casting Notes
Indie, tech comedy; glasses optional per scene.
...
**Save to:** `C:\Users\NCG\Videos\Grok Projects\Studio\actors_roster\male\europe_east\Tomas_Novak\01_casting_shots/casting_prompt.txt`
...
1. **Always lead with exact age:** `26-year-old Czech man...`
