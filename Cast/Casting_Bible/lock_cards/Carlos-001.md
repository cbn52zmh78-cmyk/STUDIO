...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/latin_america/Carlos_Mendez/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/latin_america/Carlos_Mendez`
...
```json
{
  ...
  "notes": "Low Spanish baritone; tango phrasing.",
  "performance_style": "Tango posture always; pride in spine.",
  "prompt_suffix": "Low Spanish baritone; tango phrasing.",
  "gender": "male"
}
```

## Tags
- **Persona:** melancholic, magnetic, proud, Melancholic lead, Tango past, Magnetic aging romantic
