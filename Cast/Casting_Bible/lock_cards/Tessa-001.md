...
|-------|-------|
| Actor ID | `Tessa-001` |
| Stage name | Tessa Walsh |
| Talent ID | `tessa_walsh` |
| Age (locked) | **27** |
| Gender | female |
...
```json
{
  ...
  "notes": "Australian drawl; sharpens in crisis.",
  "performance_style": "Relaxed body; urgency in eyes.",
  "prompt_suffix": "Australian drawl; sharpens in crisis.",
  "gender": "female"
}
```

## Tags
- **Persona:** laid-back, charming, stubborn, Surf drama lead, Laid-back detective, Reluctant hero
