...
|-------|-------|
| Actor ID | `Vikram-001` |
| Stage name | Vikram Rathore |
| Talent ID | `vikram_rathore` |
| Age (locked) | **32** |
| Gender | male |
...
```json
{
  ...
  "notes": "Resonant Hindi baritone; English BBC-Indian polish.",
  "performance_style": "Eyes-and-beard storytelling; sword work sells emotion.",
  "prompt_suffix": "Resonant Hindi baritone; English BBC-Indian polish.",
  "gender": "male"
}
```

## Tags
- **Persona:** commanding, passionate, noble, Bollywood prestige lead, Period warrior beauty, Family saga patriarch-young
- **Genre:** editorial_ready, family_saga, leading_role, mentor_drama, romance

## Guardrails
- Synthetic-only; do not reference or generate real-person/celebrity likeness.
- Lead every generation prompt with exact age: `32-year-old`.
