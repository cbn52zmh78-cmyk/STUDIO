...
|-------|-------|
| Actor ID | `Andre-001` |
| Stage name | Andre Silva |
| Talent ID | `andre_silva` |
| Age (locked) | **27** |
| Gender | male |
| Ethnicity | Brazilian |
...
```json
{
  ...
  "notes": "Bright Brazilian Portuguese; English sunny coastal.",
  "performance_style": "Physical joy; stunts sell stakes.",
  "prompt_suffix": "Bright Brazilian Portuguese; English sunny coastal.",
  "gender": "male"
}
```

## Tags
- **Persona:** playful, magnetic, resilient, Beach romance lead, Sports drama hero, Campaign golden boy
