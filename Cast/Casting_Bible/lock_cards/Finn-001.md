...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/europe_west/Finn_Macallister/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/europe_west/Finn_Macallister`
...
```json
{
  ...
  "notes": "Rumbling Scottish baritone.",
  "performance_style": "Physical honesty; humor through beard.",
  "prompt_suffix": "Rumbling Scottish baritone.",
  "gender": "male"
}
```

## Tags
- **Persona:** gruff, protective, wry, Outlander energy lead, Gruff protector, Secret softie
