...
| Field | Value |
|-------|-------|
| Actor ID | `Isabella-001` |
| Stage name | Isabella Vargas |
| Talent ID | `isabella_vargas` |
| Age (locked) | **29** |
| Gender | female |
...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/female/latin_america/Isabella_Vargas/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/female/latin_america/Isabella_Vargas`
...
```json
{
  ...
  "notes": "Warm mezzo; Spanish emotion peaks.",
  "performance_style": "Heart-on-sleeve with grounded feet.",
  "prompt_suffix": "Warm mezzo; Spanish emotion peaks.",
  "gender": "female"
}
```

## Tags
- **Persona:** passionate, fiery, loyal, Family drama lead, Passionate romantic, Comedic firecracker
