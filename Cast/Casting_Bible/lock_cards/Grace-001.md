...
|-------|-------|
| Actor ID | `Grace-001` |
| Stage name | Grace Okonkwo |
| Talent ID | `grace_okonkwo` |
| Age (locked) | **23** |
| Gender | female |
| Ethnicity | Ghanaian |
...
```json
{
  ...
  "notes": "Bright clear tone; Twi song cadence in celebration scenes.",
  "performance_style": "Open emotional access; smile through tears.",
  "prompt_suffix": "Bright clear tone; Twi song cadence in celebration scenes.",
  "gender": "female"
}
```

## Tags
- **Persona:** radiant, honest, spirited, Rising ingénue, Activist lead, Joy under pressure
