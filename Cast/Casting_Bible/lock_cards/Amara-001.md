...
|-------|-------|
| Actor ID | `Amara-001` |
| Stage name | Amara Singh |
| Talent ID | `amara_singh` |
| Age (locked) | **30** |
| Gender | female |
...
```json
{
  ...
  "prompt_suffix": "London crisp; Punjabi warmth with family.",
  "gender": "female"
}
```

## Tags
- **Persona:** confident, teasing, fierce, Action co-lead, Rebel lawyer, Teasing romantic lead
