# Valentina-001 — Valentina Moreau
...
| Field | Value |
|-------|-------|
| Actor ID | `Valentina-001` |
| Stage name | Valentina Moreau |
| Talent ID | `valentina_moreau` |
| Age (locked) | **47** |
| Gender | female |
...
```json
{
  ...
  "notes": "Low melodic register; French cadence on emotional peaks.",
  "performance_style": "Precision and poise; every gesture placed.",
  "prompt_suffix": "Low melodic register; French cadence on emotional peaks.",
  "gender": "female"
}
```

## Tags
- **Persona:** charming, commanding, knowing, Mature femme lead, Power broker with grace, Mother-figure with secrets
...
- Lead every generation prompt with exact age: `47-year-old`.
