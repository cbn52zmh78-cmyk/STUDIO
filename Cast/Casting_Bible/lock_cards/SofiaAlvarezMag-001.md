...
| Field | Value |
|-------|-------|
| Actor ID | `SofiaAlvarezMag-001` |
| Stage name | Sofia Alvarez |
| Talent ID | `mag_sofia_alvarez` |
| Age (locked, **21+**) | **27** |
| Gender | female |
| Ethnicity | Brazilian |
...
## Reference
- **Primary plate:** `STUDIO/MAGAZINE/Editorial/Models/Sofia Alvarez/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/MAGAZINE/Editorial/Models/Sofia Alvarez`
...
## Tags
- **Persona:** stunning curvy athletic supermodel with warm tan skin
