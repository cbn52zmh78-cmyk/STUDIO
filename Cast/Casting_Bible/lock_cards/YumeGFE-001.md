...
```json
{
  ...
  "notes": "Hawaiian-tinged English; melodic laugh.",
  "performance_style": "Improvisational touch beats; excels in handheld intimacy.",
  "prompt_suffix": "Hawaiian-tinged English; melodic laugh.",
  "gender": "female"
}
```

## Tags
- **Persona:** Island girlfriend fantasy, Beach-house romance, Laugh-first intimacy, sunny, mischievous, affectionate
...
- Lead every generation prompt with exact age: `21-year-old` (**minimum 21+**).
