...
|-------|-------|
| Actor ID | `Chiara-001` |
| Stage name | Chiara Romano |
| Talent ID | `chiara_romano` |
| Age (locked) | **34** |
| Gender | female |
| Ethnicity | Italian |
| Region | europe_west |
...
```json
{
  ...
  "notes": "Rich mezzo; laughter arrives before anger.",
  "performance_style": "High emotional bandwidth with grounded feet.",
  "prompt_suffix": "Rich mezzo; laughter arrives before anger.",
  "gender": "female"
}
```

## Tags
- **Persona:** witty, passionate, volatile, Romantic lead, Passionate antagonist, Family saga anchor
