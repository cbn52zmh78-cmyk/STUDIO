# Oluwaseun-001 — Oluwaseun Bakare
...
| Field | Value |
|-------|-------|
| Actor ID | `Oluwaseun-001` |
| Stage name | Oluwaseun Bakare |
| Talent ID | `oluwaseun_bakare` |
| Age (locked) | **33** |
| Gender | male |
| Ethnicity | Nigerian |
...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/sub_saharan_africa/Oluwaseun_Bakare/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/sub_saharan_africa/Oluwaseun_Bakare`
...
```json
{
  ...
  "notes": "Rich baritone; orator pace.",
  "performance_style": "Oratory training visible; smile weaponized.",
  "prompt_suffix": "Rich baritone; orator pace.",
  "gender": "male"
}
```

## Tags
- **Persona:** confident, persuasive, magnetic, Political drama lead, Persuasive orator, Charm offensive
