...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/female/latin_america/Carmen_Delgado/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/female/latin_america/Carmen_Delgado`
...
```json
{
  ...
  "notes": "Smoky alto; laughter low and real.",
  "performance_style": "Rhythm in hips and speech; defiance in chin.",
  "prompt_suffix": "Smoky alto; laughter low and real.",
  "gender": "female"
}
```

## Tags
- **Persona:** vivacious, strategic, defiant, Strategic operator, Dance-club queen, Survivor lead
