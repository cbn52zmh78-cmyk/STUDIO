...
|-------|-------|
| Actor ID | `Rachel-001` |
| Stage name | Rachel Cohen |
| Talent ID | `rachel_cohen` |
| Age (locked) | **36** |
| Gender | female |
...
```json
{
  ...
  "notes": "Brooklyn-leaning cadence when passionate.",
  "performance_style": "Timing-driven; punchlines as character.",
  "prompt_suffix": "Brooklyn-leaning cadence when passionate.",
  "gender": "female"
}
```

## Tags
- **Persona:** sardonic, sharp, warm, Legal drama lead, Sharp best friend, Moral center
...
- Lead every generation prompt with exact age: `36-year-old`.
