...
| Field | Value |
|-------|-------|
| Actor ID | `VioletGFE-001` |
| Stage name | Violet |
| Talent ID | `gfe_violet` |
| Age (locked, **21+**) | **22** |
| Gender | female |
...
```json
{
  ...
  "notes": "Portuguese pet names; melodic laugh.",
  "performance_style": "Rhythm in hips and hands; dialogue secondary in love scenes.",
  "prompt_suffix": "Portuguese pet names; melodic laugh.",
  "gender": "female"
}
```

## Tags
- **Persona:** Carnival-to-quiet girlfriend, Dance-then-intimacy arc, Joyful romance lead, joyful, sensual, grounded
