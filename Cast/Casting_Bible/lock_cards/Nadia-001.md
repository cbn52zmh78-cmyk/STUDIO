...
|-------|-------|
| Actor ID | `Nadia-001` |
| Stage name | Nadia Okoro |
| Talent ID | `nadia_okoro` |
| Age (locked) | **42** |
| Gender | female |
...
```json
{
  ...
  "notes": "Low resonant voice; pauses for effect.",
  "performance_style": "Stillness as power; eye contact weaponized.",
  "prompt_suffix": "Low resonant voice; pauses for effect.",
  "gender": "female"
}
```

## Tags
- **Persona:** commanding, dry, principled, Authority figure, Political thriller lead, Unshakeable mentor
- **Genre:** diaspora_drama, prestige_tv, romance

## Guardrails
- Synthetic-only; do not reference or generate real-person/celebrity likeness.
- Lead every generation prompt with exact age: `42-year-old`.
