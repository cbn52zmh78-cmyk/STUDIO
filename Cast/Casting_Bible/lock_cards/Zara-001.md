...
|-------|-------|
| Actor ID | `Zara-001` |
| Stage name | Zara Adebayo |
| Talent ID | `zara_adebayo` |
| Age (locked) | **28** |
| Gender | female |
...
```json
{
  ...
  "notes": "Rich warm timbre; laughter fills room.",
  "performance_style": "Presence-first; owns frame without shouting.",
  "prompt_suffix": "Rich warm timbre; laughter fills room.",
  "gender": "female"
}
```

## Tags
- **Persona:** bold, magnetic, warm, Magnetic lead, CEO energy, Romantic powerhouse
