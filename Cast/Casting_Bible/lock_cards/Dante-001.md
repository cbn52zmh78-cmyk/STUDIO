...
|-------|-------|
| Actor ID | `Dante-001` |
| Stage name | Dante Reyes |
| Talent ID | `dante_reyes` |
| Age (locked) | **26** |
| Gender | male |
| Ethnicity | Mexican |
...
```json
{
  ...
  "notes": "Rich Mexican baritone; English warm with musical rhythm.",
  "performance_style": "Hip-and-shoulder storytelling; eyes sell the wound.",
  "prompt_suffix": "Rich Mexican baritone; English warm with musical rhythm.",
  "gender": "male"
}
```

## Tags
- **Persona:** fiery, magnetic, tender, Passion-lead, Boxer-poet hero, Revenge romance icon
