...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/europe_west/Pierre_Dubois/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/europe_west/Pierre_Dubois`
...
```json
{
  ...
  "notes": "Melodic French baritone; English crisp.",
  "performance_style": "Precision and flair; hands choreographed.",
  "prompt_suffix": "Melodic French baritone; English crisp.",
  "gender": "male"
}
```

## Tags
- **Persona:** sophisticated, mocking, charismatic, Sophisticated antagonist, Chef / artist lead, Mocking intellect
...
- Lead every generation prompt with exact age: `41-year-old`.
