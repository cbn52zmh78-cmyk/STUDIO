...
|-------|-------|
| Actor ID | `Noor-001` |
| Stage name | Noor El-Amir |
| Talent ID | `noor_el_amir` |
| Age (locked) | **27** |
| Gender | female |
| Ethnicity | Lebanese |
...
```json
{
  ...
  "notes": "Melodic Levantine Arabic; French purr in English scenes.",
  "performance_style": "Regal micro-expressions; stillness as power.",
  "prompt_suffix": "Melodic Levantine Arabic; French purr in English scenes.",
  "gender": "female"
}
```

## Tags
- **Persona:** enigmatic, graceful, sharp, Mediterranean muse, Political drama beauty, Old-money mystery
- **Genre:** editorial_ready, leading_role, political_drama, romance, thriller
