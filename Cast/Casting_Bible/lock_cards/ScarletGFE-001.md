...
| Field | Value |
|-------|-------|
| Actor ID | `ScarletGFE-001` |
| Stage name | Scarlet |
| Talent ID | `gfe_scarlet` |
| Age (locked, **21+**) | **28** |
| Gender | female |
| Ethnicity | Japanese |
| Region | east_asia |
...
```json
{
  ...
  "notes": "Confident mezzo; drops to whisper for vulnerability.",
  "performance_style": "Camera-aware without breaking fourth wall in drama.",
  "prompt_suffix": "Confident mezzo; drops to whisper for vulnerability.",
  "gender": "female"
}
```

## Tags
- **Persona:** Mature girlfriend fantasy, After-hours confessional, Confidence-forward romance, bold, knowing, generous
...
- Lead every generation prompt with exact age: `28-year-old` (**minimum 21+**).
