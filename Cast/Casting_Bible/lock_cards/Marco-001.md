...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/europe_west/Marco_Esposito/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/europe_west/Marco_Esposito`
...
```json
{
  ...
  "notes": "Rich tenor; Italian peaks on anger.",
  "performance_style": "Full-body emotion; voice carries.",
  "prompt_suffix": "Rich tenor; Italian peaks on anger.",
  "gender": "male"
}
```

## Tags
- **Persona:** passionate, theatrical, loyal, Passionate romantic lead, Hot-headed brother, Theatrical artist
