...
|-------|-------|
| Actor ID | `Linh-001` |
| Stage name | Linh Nguyen |
| Talent ID | `linh_nguyen` |
| Age (locked) | **25** |
| Gender | female |
...
```json
{
  ...
  "notes": "Soft melodic tone; Vietnamese lullaby cadence in memory scenes.",
  "performance_style": "Movement-first emotion; hands tell story.",
  "prompt_suffix": "Soft melodic tone; Vietnamese lullaby cadence in memory scenes.",
  "gender": "female"
}
```

## Tags
- **Persona:** gentle, mischievous, sensitive, Immigrant story lead, Dance-driven emotion, Gentle rebel
- **Genre:** immigrant_story, indie_drama, romance
