...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/female/north_america/Serena_Blake/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/female/north_america/Serena_Blake`
...
```json
{
  ...
  "notes": "Rich Southern coastal timbre; can sharpen to boardroom steel.",
  "performance_style": "Open emotional register; owns two-shots with stillness.",
  "prompt_suffix": "Rich Southern coastal timbre; can sharpen to boardroom steel.",
  "gender": "female"
}
```

## Tags
- **Persona:** radiant, commanding, warm, Power-lead beauty, Romantic drama queen, Executive glam
- **Genre:** editorial_ready, indie_drama, leading_role, prestige_tv, procedural, rom_com

## Guardrails
- Synthetic-only; do not reference or generate real-person/celebrity likeness.
- Lead every generation prompt with exact age: `30-year-old`.
