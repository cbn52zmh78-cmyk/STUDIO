...
```json
{
  ...
  "notes": "Deep measured baritone.",
  "performance_style": "Stillness fills frame; voice low.",
  "prompt_suffix": "Deep measured baritone.",
  "gender": "male"
}
```

## Tags
- **Persona:** intense, protective, measured, Protector lead, Intense father, Quiet authority
