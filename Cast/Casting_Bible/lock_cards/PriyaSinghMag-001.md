...
| Field | Value |
|-------|-------|
| Actor ID | `PriyaSinghMag-001` |
| Stage name | Priya Singh |
| Talent ID | `mag_priya_singh` |
| Age (locked, **21+**) | **24** |
| Gender | female |
...
## Reference
- **Primary plate:** `STUDIO/MAGAZINE/Editorial/Models/Priya Singh/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/MAGAZINE/Editorial/Models/Priya Singh`
...
## Tags
- **Persona:** warm golden stunning supermodel with long wavy hair and subtle highlights
