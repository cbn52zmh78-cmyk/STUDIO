...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/sub_saharan_africa/Kofi_Mensah/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/sub_saharan_africa/Kofi_Mensah`
...
```json
{
  ...
  "notes": "Warm Ghanaian English; laugh lines in voice when relaxed.",
  "performance_style": "Physical honesty; joy and grief both full-body.",
  "prompt_suffix": "Warm Ghanaian English; laugh lines in voice when relaxed.",
  "gender": "male"
}
```

## Tags
- **Persona:** radiant, grounded, charismatic, Global campaign lead, Romantic drama hero, Athlete-turned-actor
- **Genre:** diaspora_drama, editorial_ready, leading_role, prestige_tv, romance

## Guardrails
- Synthetic-only; do not reference or generate real-person/celebrity likeness.
- Lead every generation prompt with exact age: `28-year-old`.
