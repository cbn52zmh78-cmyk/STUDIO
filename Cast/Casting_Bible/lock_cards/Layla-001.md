...
|-------|-------|
| Actor ID | `Layla-001` |
| Stage name | Layla Mansour |
| Talent ID | `layla_mansour` |
| Age (locked) | **31** |
| Gender | female |
...
```json
{
  ...
  "notes": "Trilingual code-switch; Arabic poetry cadence.",
  "performance_style": "Words as weapons and bandages.",
  "prompt_suffix": "Trilingual code-switch; Arabic poetry cadence.",
  "gender": "female"
}
```

## Tags
- **Persona:** eloquent, guarded, empathetic, War-zone journalist, Eloquent defender, Guarded romantic
