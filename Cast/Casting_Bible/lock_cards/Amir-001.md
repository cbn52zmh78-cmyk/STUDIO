...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/middle_east_north_africa/Amir_Khalil/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/middle_east_north_africa/Amir_Khalil`
...
```json
{
  ...
  "notes": "Smooth baritone; Arabic prayer cadence.",
  "performance_style": "Calm hands; charm evidence-based.",
  "prompt_suffix": "Smooth baritone; Arabic prayer cadence.",
  "gender": "male"
}
```

## Tags
- **Persona:** smooth, principled, charming, Principled lead, Doctor past, Smooth diplomat
