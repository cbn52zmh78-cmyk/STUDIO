...
|-------|-------|
| Actor ID | `Ethan-001` |
| Stage name | Ethan Shaw |
| Talent ID | `ethan_shaw` |
| Age (locked) | **29** |
| Gender | male |
...
```json
{
  ...
  "notes": "Relaxed New Zealand baritone; gravel under stress.",
  "performance_style": "Physical authenticity; silence carries weight.",
  "prompt_suffix": "Relaxed New Zealand baritone; gravel under stress.",
  "gender": "male"
}
```

## Tags
- **Persona:** bold, laid-back, steadfast, Coastal action lead, Eco-thriller hero, Surf-noir romantic
