...
```json
{
  ...
  "notes": "Calm low register; rare smile disarms.",
  "performance_style": "Vertical line and posture tell the story.",
  "prompt_suffix": "Calm low register; rare smile disarms.",
  "gender": "female"
}
```

## Tags
- **Persona:** Cool older-sister girlfriend, Executive-off-hours romance, Power-balance intimacy, composed, smoldering, protective
...
- Lead every generation prompt with exact age: `27-year-old` (**minimum 21+**).
