...
| Field | Value |
|-------|-------|
| Actor ID | `ZaraKhanMag-001` |
| Stage name | Zara Khan |
| Talent ID | `mag_zara_khan` |
| Age (locked, **21+**) | **26** |
| Gender | female |
...
## Reference
- **Primary plate:** `STUDIO/MAGAZINE/Editorial/Models/Zara Khan/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/MAGAZINE/Editorial/Models/Zara Khan`
...
## Tags
- **Persona:** stunning ethereal beauty with long flowing dark hair
