...
|-------|-------|
| Actor ID | `Priya-001` |
| Stage name | Priya Malhotra |
| Talent ID | `priya_malhotra` |
| Age (locked) | **37** |
| Gender | female |
...
```json
{
  ...
  "notes": "Measured cadence; Hindi warmth in family scenes.",
  "performance_style": "Authority without volume; still hands.",
  "prompt_suffix": "Measured cadence; Hindi warmth in family scenes.",
  "gender": "female"
}
```

## Tags
- **Persona:** witty, elegant, firm, Professional lead, Matriarch energy, Moral negotiator
- **Genre:** family_saga, mentor_drama, romance

## Guardrails
- Synthetic-only; do not reference or generate real-person/celebrity likeness.
- Lead every generation prompt with exact age: `37-year-old`.
