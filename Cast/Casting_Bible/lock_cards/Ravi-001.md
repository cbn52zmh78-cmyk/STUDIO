...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/south_asia/Ravi_Menon/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/south_asia/Ravi_Menon`
...
```json
{
  ...
  "notes": "Soft British; Tamil lullaby rhythm.",
  "performance_style": "Listen-first acting; kindness without softness.",
  "prompt_suffix": "Soft British; Tamil lullaby rhythm.",
  "gender": "male"
}
```

## Tags
- **Persona:** gentle, observant, patient, Gentle mentor, Teacher lead, Observant father
- **Genre:** family_saga, mentor_drama, romance

## Guardrails
- Synthetic-only; do not reference or generate real-person/celebrity likeness.
- Lead every generation prompt with exact age: `38-year-old`.
