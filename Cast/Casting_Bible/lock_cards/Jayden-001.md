...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/oceania_pacific/Jayden_Tau/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/oceania_pacific/Jayden_Tau`
...
```json
{
  ...
  "notes": "Deep warm baritone; Te Reo ceremonial cadence.",
  "performance_style": "Physical power with gentle hands.",
  "prompt_suffix": "Deep warm baritone; Te Reo ceremonial cadence.",
  "gender": "male"
}
```

## Tags
- **Persona:** grounded, playful, proud, Grounded warrior lead, Community anchor, Playful giant
