...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/europe_east/Viktor_Petrov/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/europe_east/Viktor_Petrov`
...
```json
{
  ...
  "notes": "Low calm voice; Ukrainian lullaby cadence.",
  "performance_style": "Weight in shoulders; love in labor.",
  "prompt_suffix": "Low calm voice; Ukrainian lullaby cadence.",
  "gender": "male"
}
```

## Tags
- **Persona:** guarded, dry, resilient, Immigrant saga lead, Construction boss, Guarded father
