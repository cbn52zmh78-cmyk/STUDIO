...
| Field | Value |
|-------|-------|
| Actor ID | `BridgetOkafor-001` |
| Stage name | Bridget Okafor |
| Talent ID | `bridget_okafor` |
| Age (locked) | **35** |
| Gender | female |
...
```json
{
  ...
  "notes": "Crisp British; Swahili softness in family flashbacks.",
  "performance_style": "Intellectual urgency; walks with purpose.",
  "prompt_suffix": "Crisp British; Swahili softness in family flashbacks.",
  "gender": "female"
}
```

## Tags
- **Persona:** ambitious, warm, incisive, Journalist lead, Ambitious professional, Warm rival
- **Genre:** diaspora_drama, prestige_tv, romance

## Guardrails
- Synthetic-only; do not reference or generate real-person/celebrity likeness.
- Lead every generation prompt with exact age: `35-year-old`.
