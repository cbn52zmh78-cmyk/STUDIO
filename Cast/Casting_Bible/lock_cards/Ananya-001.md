...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/female/south_asia/Ananya_Reddy/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/female/south_asia/Ananya_Reddy`
...
```json
{
  ...
  "notes": "Musical Telugu cadence; English polished BBC-Indian neutral.",
  "performance_style": "Eyes-and-hands storytelling; dance training in posture.",
  "prompt_suffix": "Musical Telugu cadence; English polished BBC-Indian neutral.",
  "gender": "female"
}
```

## Tags
- **Persona:** luminous, passionate, grounded, Bollywood prestige lead, Classical dancer beauty, Family saga anchor
