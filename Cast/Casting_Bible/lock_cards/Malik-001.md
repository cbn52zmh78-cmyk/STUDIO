...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/sub_saharan_africa/Malik_Diallo/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/sub_saharan_africa/Malik_Diallo`
...
```json
{
  ...
  "notes": "French lyric baritone.",
  "performance_style": "Body as instrument; still face.",
  "prompt_suffix": "French lyric baritone.",
  "gender": "male"
}
```

## Tags
- **Persona:** elegant, provocative, cool, Fashion lead, Provocative artist, Elegant rebel
