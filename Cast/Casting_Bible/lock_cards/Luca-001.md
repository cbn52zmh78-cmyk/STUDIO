...
|-------|-------|
| Actor ID | `Luca-001` |
| Stage name | Luca Fontaine |
| Talent ID | `luca_fontaine` |
| Age (locked) | **29** |
| Gender | male |
...
```json
{
  ...
  "notes": "Low warm Mediterranean baritone; English polished Parisian.",
  "performance_style": "Still torso, emotion in eyes; economy in dialogue.",
  "prompt_suffix": "Low warm Mediterranean baritone; English polished Parisian.",
  "gender": "male"
}
```

## Tags
- **Persona:** smoldering, charming, focused, Luxury campaign lead, Romantic thriller hero, Couture-era leading man
