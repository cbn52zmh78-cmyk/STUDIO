...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/europe_east/Dmitri_Kozlov/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/europe_east/Dmitri_Kozlov`
...
```json
{
  ...
  "notes": "Low Russian baritone; quiet threat.",
  "performance_style": "Ballet economy; violence clean.",
  "prompt_suffix": "Low Russian baritone; quiet threat.",
  "gender": "male"
}
```

## Tags
- **Persona:** brooding, precise, intense, Brooding lead, Assassin poise, Redemption arc
- **Genre:** cold_war, noir, prestige_tv, thriller

## Guardrails
- Synthetic-only; do not reference or generate real-person/celebrity likeness.
- Lead every generation prompt with exact age: `40-year-old`.
