...
```json
{
  ...
  "notes": "Quiet sudden laugh; drops half octave when lying.",
  "performance_style": "Rooney Mara stillness meets Plaza dry mischief.",
  "prompt_suffix": "Quiet sudden laugh; drops half octave when lying.",
  "gender": "female"
}
```

## Tags
- **Persona:** Survivor girlfriend, Reaction-shot specialist, Rebellious romantic interest, stoic, dry, warm
...
- Lead every generation prompt with exact age: `24-year-old` (**minimum 21+**).
