...
| Field | Value |
|-------|-------|
| Actor ID | `BridgetWalsh-001` |
| Stage name | Bridget Walsh |
| Talent ID | `bridget_walsh` |
| Age (locked) | **39** |
| Gender | female |
...
```json
{
  ...
  "notes": "Boston edge; softens for victims' families.",
  "performance_style": "Physical commitment; tired eyes sell long cases.",
  "prompt_suffix": "Boston edge; softens for victims' families.",
  "gender": "female"
}
```

## Tags
- **Persona:** gruff, loyal, funny, Detective lead, Working-class hero, Protector
...
- Lead every generation prompt with exact age: `39-year-old`.
