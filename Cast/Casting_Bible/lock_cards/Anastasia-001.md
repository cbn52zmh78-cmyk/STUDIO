...
| Field | Value |
|-------|-------|
| Actor ID | `Anastasia-001` |
| Stage name | Anastasia Volkov |
| Talent ID | `anastasia_volkov` |
| Age (locked) | **33** |
| Gender | female |
...
```json
{
  ...
  "notes": "Low cool register; Russian accent surfaces under stress.",
  "performance_style": "Discipline and line; stillness as threat.",
  "prompt_suffix": "Low cool register; Russian accent surfaces under stress.",
  "gender": "female"
}
```

## Tags
- **Persona:** icy, layered, precise, Ice-queen lead, Spy adjacent, Tragic elegance
- **Genre:** cold_war, noir, prestige_tv, thriller

## Guardrails
- Synthetic-only; do not reference or generate real-person/celebrity likeness.
- Lead every generation prompt with exact age: `33-year-old`.
