...
| Field | Value |
|-------|-------|
| Actor ID | `MeiLing-001` |
| Stage name | Mei-Ling Chen |
| Talent ID | `mei_ling_chen` |
| Age (locked) | **27** |
| Gender | female |
| Ethnicity | Taiwanese |
| Region | east_asia |
...
```json
{
  ...
  "notes": "Clear Mandarin; English bright and quick.",
  "performance_style": "Open face; listens actively in two-shots.",
  "prompt_suffix": "Clear Mandarin; English bright and quick.",
  "gender": "female"
}
```

## Tags
- **Persona:** bright, earnest, resilient, Romantic lead, Startup founder type, Optimist under pressure
