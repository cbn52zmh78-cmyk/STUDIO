...
|-------|-------|
| Actor ID | `Khalid-001` |
| Stage name | Khalid Mansour |
| Talent ID | `khalid_mansour` |
| Age (locked) | **30** |
| Gender | male |
| Ethnicity | Egyptian |
...
```json
{
  ...
  "notes": "Melodic Cairene Arabic; English smooth and low.",
  "performance_style": "Economical gestures; power in pause.",
  "prompt_suffix": "Melodic Cairene Arabic; English smooth and low.",
  "gender": "male"
}
```

## Tags
- **Persona:** regal, enigmatic, passionate, Desert epic hero, International diplomat lead, Mystery romance
