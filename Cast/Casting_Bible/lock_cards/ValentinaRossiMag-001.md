...
| Field | Value |
|-------|-------|
| Actor ID | `ValentinaRossiMag-001` |
| Stage name | Valentina Rossi |
| Talent ID | `mag_valentina_rossi` |
| Age (locked, **21+**) | **25** |
| Gender | female |
| Ethnicity | Italian |
...
## Reference
- **Primary plate:** `STUDIO/MAGAZINE/Editorial/Models/Valentina Rossi/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/MAGAZINE/Editorial/Models/Valentina Rossi`
...
## Tags
- **Persona:** striking supermodel beauty with sharp defined cheekbones
