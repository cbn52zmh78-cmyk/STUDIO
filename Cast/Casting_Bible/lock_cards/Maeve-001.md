...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/female/europe_west/Maeve_O_Sullivan/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/female/europe_west/Maeve_O_Sullivan`
...
```json
{
  ...
  "notes": "Lilt thickens when emotional or lying.",
  "performance_style": "Musical rhythm to speech; big eyes, small gestures.",
  "prompt_suffix": "Lilt thickens when emotional or lying.",
  "gender": "female"
}
```

## Tags
- **Persona:** whimsical, blunt, warm, Folk-horror lead, Whimsical best friend, Truth-teller
