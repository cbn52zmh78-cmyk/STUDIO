...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/latin_america/Diego_Morales/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/latin_america/Diego_Morales`
...
```json
{
  ...
  "notes": "Gravelly tenor; Spanish song phrasing.",
  "performance_style": "Music in movement; temper in jaw.",
  "prompt_suffix": "Gravelly tenor; Spanish song phrasing.",
  "gender": "male"
}
```

## Tags
- **Persona:** charismatic, hot-tempered, soulful, Hot-headed lead, Musician past, Charismatic rebel
