...
| Field | Value |
|-------|-------|
| Actor ID | `WillowGFE-001` |
| Stage name | Willow |
| Talent ID | `gfe_willow` |
| Age (locked, **21+**) | **23** |
| Gender | female |
| Ethnicity | Japanese |
| Region | east_asia |
...
```json
{
  ...
  "notes": "ASMR-soft register; long exhales before lines.",
  "performance_style": "Body as text; stillness is dialogue.",
  "prompt_suffix": "ASMR-soft register; long exhales before lines.",
  "gender": "female"
}
```

## Tags
- **Persona:** Wellness girlfriend fantasy, Morning ritual intimacy, Breath-led romance, calm, sensual, present
...
- Lead every generation prompt with exact age: `23-year-old` (**minimum 21+**).
