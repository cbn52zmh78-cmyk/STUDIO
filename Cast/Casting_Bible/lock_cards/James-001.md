...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/europe_west/James_Whitmore/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/europe_west/James_Whitmore`
...
```json
{
  ...
  "notes": "Low steady baritone; Yorkshire slips when tired.",
  "performance_style": "Economy and weight; stillness sells rank.",
  "prompt_suffix": "Low steady baritone; Yorkshire slips when tired.",
  "gender": "male"
}
```

## Tags
- **Persona:** stoic, dry, dependable, Stoic lead, Military officer, Dry mentor
