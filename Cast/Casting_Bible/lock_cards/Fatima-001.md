...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/female/middle_east_north_africa/Fatima_Al_Hassan/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/female/middle_east_north_africa/Fatima_Al_Hassan`
...
```json
{
  ...
  "notes": "French precision; Arabic warmth in family scenes.",
  "performance_style": "Still posture; eyes carry subtext.",
  "prompt_suffix": "French precision; Arabic warmth in family scenes.",
  "gender": "female"
}
```

## Tags
- **Persona:** poised, fierce, observant, Fashion-world lead, Poised outsider, Quiet rebel
- **Genre:** political_drama, romance, thriller
