...
| Field | Value |
|-------|-------|
| Actor ID | `Camille-001` |
| Stage name | Camille Reyes |
| Talent ID | `camille_reyes` |
| Age (locked) | **26** |
| Gender | female |
| Ethnicity | Colombian |
...
```json
{
  ...
  "notes": "Warm Colombian lilt; English bright with musical rhythm.",
  "performance_style": "Hip-and-shoulder storytelling; eyes lead every beat.",
  "prompt_suffix": "Warm Colombian lilt; English bright with musical rhythm.",
  "gender": "female"
}
```

## Tags
- **Persona:** fiery, playful, smoldering, Passion-lead, Dance-driven seductress, Revenge glam
