...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/europe_west/Lars_Eriksson/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/europe_west/Lars_Eriksson`
...
```json
{
  ...
  "notes": "Low sparse delivery; Swedish accent faint.",
  "performance_style": "Physical presence; emotion in jaw.",
  "prompt_suffix": "Low sparse delivery; Swedish accent faint.",
  "gender": "male"
}
```

## Tags
- **Persona:** laconic, dependable, gentle, Strong silent lead, Rescue worker, Loyal brother
