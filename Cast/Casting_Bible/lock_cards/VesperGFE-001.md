...
| Field | Value |
|-------|-------|
| Actor ID | `VesperGFE-001` |
| Stage name | Vesper |
| Talent ID | `gfe_vesper` |
| Age (locked, **21+**) | **26** |
| Gender | female |
...
```json
{
  ...
  "notes": "Low melodic register; British clip when deflecting.",
  "performance_style": "Stillness with predator-prey eye-line games.",
  "prompt_suffix": "Low melodic register; British clip when deflecting.",
  "gender": "female"
}
```

## Tags
- **Persona:** Goth girlfriend fantasy, Noir romantic interest, Late-night confessional lead, nocturnal, wry, sensual
...
- Lead every generation prompt with exact age: `26-year-old` (**minimum 21+**).
