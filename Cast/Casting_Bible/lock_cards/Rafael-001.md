...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/latin_america/Rafael_Costa/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/latin_america/Rafael_Costa`
...
```json
{
  ...
  "notes": "Warm Portuguese-tinged English.",
  "performance_style": "Physical grace; smile as punctuation.",
  "prompt_suffix": "Warm Portuguese-tinged English.",
  "gender": "male"
}
```

## Tags
- **Persona:** flirtatious, soulful, warm, Romantic lead, Flirtatious neighbor, Soulful athlete
- **Genre:** crime_drama, romance, telenovela_adjacent
