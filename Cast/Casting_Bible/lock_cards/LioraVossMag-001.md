...
| Field | Value |
|-------|-------|
| Actor ID | `LioraVossMag-001` |
| Stage name | Liora Voss |
| Talent ID | `mag_liora_voss` |
| Age (locked, **21+**) | **24** |
| Gender | female |
...
## Reference
- **Primary plate:** `STUDIO/MAGAZINE/Editorial/Models/Liora Voss/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/MAGAZINE/Editorial/Models/Liora Voss`
...
## Tags
- **Persona:** very attractive willowy supermodel with platinum blonde blunt bob
