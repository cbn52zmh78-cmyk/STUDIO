...
## Reference
- **Primary plate:** `STUDIO/Cast/actors_roster/male/middle_east_north_africa/Hassan_Odeh/01_casting_shots/casting_turnaround_v1.jpg`
- **Roster path:** `STUDIO/Cast/actors_roster/male/middle_east_north_africa/Hassan_Odeh`
...
```json
{
  ...
  "notes": "Low calm baritone; Arabic precision.",
  "performance_style": "Stillness; words measured.",
  "prompt_suffix": "Low calm baritone; Arabic precision.",
  "gender": "male"
}
```

## Tags
- **Persona:** calm, sharp, watchful, Calm strategist, Spy drama, Razor-sharp counsel
