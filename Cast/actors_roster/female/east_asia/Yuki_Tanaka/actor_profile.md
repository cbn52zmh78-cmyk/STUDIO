...
| Full legal name | Yuki Tanaka |
| Professional stage name | Yuki Tanaka |
| Age (locked) | **22** |
...
| Roster path | `C:\Users\NCG\Videos\Grok Projects\Studio\actors_roster\female\east_asia\Yuki_Tanaka` |

## Mood Modifiers (On & Off Screen)
**Modifiers:** playful, deadpan, earnest
**On-screen:** Playful default; deadpan when deflecting.
**Off-screen / video:** Bubbly in behind-the-scenes video; earnest with fans.

## Languages
- Japanese (native, Kansai dialect)
- English (intermediate)

## Physical Description
5'2", slim build, black hair in high messy bun, round dark eyes, porcelain skin, delicate jaw.

## Tattoo Inventory
None — continuity: no tattoo additions without canon update.

## Signature Looks
School-uniform canon, pastel off-duty, minimal lip.

## Archetypes
- Coming-of-age lead
- Idol-adjacent ingénue
- Rebel daughter

## Performance Style
Reactive eyes; physical comedy when script allows.

## Voice Notes
Higher register; Kansai warmth in casual scenes.
...
## Personality
Polite surface; rebellion in small acts.

## Base Reference Images / Wardrobe Anchors
- Neutral casting wardrobe anchor — Yuki Tanaka
- Primary story wardrobe — Yuki Tanaka

## Casting Notes
Youth drama, rom-com; bun hairstyle common.
...
**Save to:** `C:\Users\NCG\Videos\Grok Projects\Studio\actors_roster\female\east_asia\Yuki_Tanaka\01_casting_shots/casting_prompt.txt`
...
1. **Always lead with exact age:** `22-year-old Japanese woman...`
