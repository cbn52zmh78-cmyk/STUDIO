#!/usr/bin/env python3
"""Validate chem/physics mini-slate (#180): Gate 0 + intake + render_longform --script-only."""
...
EPISODES = [
    "science_covalent_bonding_v1",
    "science_ionic_crystal_v1",
    "science_electromagnetism_v1",
]
...
def main() -> int:
    ...
    for slug in EPISODES:
        ...
        if script.is_file():
            ...
            row["sources"] = len(
                ((data.get("intake") or {}).get("science_subject") or {}).get("sources")
