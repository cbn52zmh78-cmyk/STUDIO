#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────────
# T4 — david_old_norse_corpus_v1 — "Runes Attested, Sagas Reconstructed"
...
echo "[T4] Staging david_old_norse_corpus_v1 for render..."
python3 STUDIO/Pipeline/batch_runner.py \
    --slate dead_languages \
    --episode david_old_norse_corpus_v1

echo ""
echo "[T4] Old Norse render queued."
echo "     Output: DAVID/productions/david_old_norse_corpus_v1_longform_v1/"
