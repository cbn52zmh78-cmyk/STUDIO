#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────────
# T3 — david_old_english_corpus_v1 — "Beowulf's Tongue in Manuscript"
...
echo "[T3] Staging david_old_english_corpus_v1 for render..."
python3 STUDIO/Pipeline/batch_runner.py \
    --slate dead_languages \
    --episode david_old_english_corpus_v1

echo ""
echo "[T3] Old English render queued."
echo "     Output: DAVID/productions/david_old_english_corpus_v1_longform_v1/"
